...
var _toEliminationAggregate = require('../../src/toEliminationAggregate');

var express = require('express');
var router = express.Router();


var eliminationAggregate = null;
...
router.get('/start', function (req, res, next) {
	...
	if (!eliminationAggregate) {
		eliminationAggregate = (0, _toEliminationAggregate.toEliminationAggregate)('testName' + new Date().toString());
		rtn = 'Event Started';
	}
	res.send(rtn);
});
