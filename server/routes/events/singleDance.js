...
import { toSingleDanceAggregate } from '../../src/toSingleDanceAggregate';

let singleDanceAggregate = null;
let toResult = null;
...
router.get('/start', function(req, res, next) {
	...
	if (!singleDanceAggregate) {
		singleDanceAggregate = toSingleDanceAggregate('testName' + new Date().toString())
		rtn = 'Event Started';
	}
	res.send(rtn);
