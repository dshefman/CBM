...
// ], function(chai, _, sinon, WeightedSingleDance, ScruitineerMultiDance) {

const chai = require('chai');
const sinon = require('sinon');
const _ = require('lodash');
const WeightedSingleDance  =  require('../../../scruitineering/WeightedSingleDance')
const WeightedMultiDance = require('../../../scruitineering/WeightedMultiDance');
    ...
    describe('Certified Correct - Scrutineering Exam Prep Book Examples', function() {
        ...
        beforeEach(function(){
           sandbox = sinon.createSandbox();
            SC =  new WeightedSingleDance(false);
            SC_Multi = new WeightedMultiDance(true);
        ...
        function assertResults(placements, dancers, results){
            for(var i = 0 ; i < dancers.length; i++){
                ...
                var isR11 = false //placements[i] == R11;
                if (!isR11) {
